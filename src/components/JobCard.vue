<template>
    ...
    >
        ...
        <div class="flex flex-col w-full px-4 md:p-4 md:flex-row md:items-center">
            <img
                class="w-12 h-12 -mt-6 rounded-full md:h-16 md:w-16 md:mt-0 md:mr-6"
                :src="companyIcon"
                alt=""
            />
            ...
            <div class="md:mr-6">
                ...
                <div class="flex flex-row items-center my-1 text-xs text-gray-cyan">
                    {{ job.postedAt }}
